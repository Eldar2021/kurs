...
import 'package:sabak15_f12/home_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  for(int i = 0; i <= students.length; i++){
    if(phone == students[i].phone&& email== students[i].email){
      Navigator.push(context, MaterialPageRoute(builder: (context) => HomePage(students[i])));
      break;
    }else{
            ...
            children: [
              Row(
                ...
                children: [
                  const CircleAvatar(
                    ...
                    backgroundImage: AssetImage('assets/images/turat_alybaev.jpg'),
                    // child: Image.asset(
              ...
              ElevatedButton(
                ...
                onPressed: isActive
                    ? () {
                        if (_phone != null && _email != null) {
                          controlEmailPhone02NoComment(_phone!, _email!);
                        }
                      }
                    : null,
                child: const Text(
