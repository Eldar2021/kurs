...
import 'package:quiz_app2/widget/quiz_button.dart';
import 'package:quiz_app2/widget/result_icon.dart';
        ...
        showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              ...
              content: Text('tuura joop ${tuuraJooptor.length}/kata joop ${kataJooptor.length}'),
            );
          },
        );
        jooptor.clear();
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int i) {
                  return jooptor[i] ? const ResultIcon(true) : const ResultIcon(false);
                },
              ),
            ),
            const SizedBox(height: 50)
